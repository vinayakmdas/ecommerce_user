...
class PersonolData {
  ...
  static Widget nameTextField({required TextEditingController controller}) {
  ...
  static Widget phoneTextField({required TextEditingController controller}) {
    return TextFormField(
      controller: controller,
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: AppColors.categoryTitle, width: 1.5),
        ),
        contentPadding: const EdgeInsets.symmetric(
          horizontal: 16,
          vertical: 14,
